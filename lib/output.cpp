...
void help_info::see_info()
{
    std::cout << "*** Статистична обробка - визначення довірчого інтервалу ***" << std::endl
              ...
              << "-d [перше число] [друге число] ... [наступне число] alf [альфа 0..1]" << std::endl
              << "-d [перший ряд ([перше] [друге] ... [наступне число])] -- [другий ряд] -- ... [наступний ряд]" << std::endl
              << "-d [перший ряд ([перше] [друге] ... [наступне число])] -- [другий ряд] -- ... [наступний ряд] alf [альфа 0..1]" << std::endl
              << std::endl
              << "Для виводу в файл:" << std::endl
              << "-df [перше число] [друге число] ... [наступне число]" << std::endl
              << "-df [перше число] [друге число] ... [наступне число] alf [альфа 0..1]" << std::endl
              << "-df [перший ряд ([перше] [друге] ... [наступне число])] -- [другий ряд] -- ... [наступний ряд]" << std::endl
              << "-df [перший ряд ([перше] [друге] ... [наступне число])] -- [другий ряд] -- ... [наступний ряд] alf [альфа 0..1]" << std::endl
              << std::endl
